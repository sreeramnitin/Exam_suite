		...
		<div id="main">
			...
			<form method="post" action = 'addexam2' style="width: 100%;height: 100%;">
				...
				<div style="display:inline-block;margin:auto">
					<div class = "space1"><input name="btn" class="bottem" type="submit" value="Add More"/></div>
					<%
						session.setAttribute("qno", 0);
						out.print("<div class = \"space1\"><input class=\"bottem\" name=\"btn\" type=\"submit\" value=\"Ok\"/></div>");
					%>
