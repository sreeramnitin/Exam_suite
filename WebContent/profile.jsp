...
<div id="main">
		...
		<div id = "disp">
			<div style="margin:auto;background-color:#3366ff;color:white;font-size:20px;text-align:center">
				Profile
			</div>
			<div>
			<form name = "profile_form" style="margin: 10px auto;width: 100%;line-height: 26px;" method="post" action="updateprofile" onsubmit="return proValidation(this)">
				<div style = "display: inline-block;width: 100%;">
					<div style="float:left">
						...
						<div id="login_ip">
							<input type = "text" name = "firstname" value="<%=u.getName() %>"/><br/>
							<input type = "text" name = "lastname" value="<%=u.getLname() %>" /><br/>
							<%=u.getEmail()%><br/>
							<input type = "password" name = "password"  ><br/>
							<input type = "password" name = "rpassword" ><br/>
							<input type = "text" name = "college"  value="<%=u.getCollege() %>"/><br/>
							</div>					
					</div>
